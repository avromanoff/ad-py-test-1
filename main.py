...
def add_new_shelf(new_shelf_number):
...
def move_doc_to_shelf(doc_number, new_shelf_number):
    # user_doc_number = input('Введите номер документа - ')
    # user_shelf_number = input('Введите номер полки для перемещения - ')
    user_doc_number = doc_number
    user_shelf_number = new_shelf_number
...
def add_new_doc(doc_number, doc_type, doc_owner_name, shelf_number):
    ...
    new_doc_number = doc_number
    new_doc_type = doc_type
    new_doc_owner_name = doc_owner_name
    new_doc_shelf_number = shelf_number
    new_doc = {
        "type": new_doc_type,
